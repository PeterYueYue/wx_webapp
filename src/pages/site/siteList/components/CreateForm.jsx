  ...
  return (
    ...
    >
      ...
      <Form form={form} name="nest-messages" onFinish={onFinish} validateMessages={validateMessages} labelCol={{ span: 8 }}>
        ...
        <Form.Item name={['communityId']} label="小区选择"  rules={[{ required: true }]}  >
          <Select  style={{ width: 200 }} placeholder="请选择" disabled={community_a.length<1}  onChange={onChange_community}  >
            {community_a.map((e,i) =>  {
