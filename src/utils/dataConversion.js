...
let sign = "";
let microServiceIp = "10.9.0.4";
if(token){
    if(payload.biz_content){
        sign = md5(`app_id=${app_id}&biz_content=${payload.biz_content}&format=json&method=${payload.method}&microServiceIp=${microServiceIp}&nonce=${nonce}&releaseVersion=${releaseVersion}&timestamp=${timestamp}&token=${token}&version=1.00878b0d87e84486dad0a9856593fb7ac`)
    }else{
